	...
	<div class="border">
		<table border="0" cellspacing="0" cellpadding="0" width="97%" class="table1">
			...
			<tr>
				...
				<td bgcolor=#F5F4F7>
					<img src="images/delete.gif" width="16" height="16" border="0" title="You can't delete superadmin">
				</td>
			</tr>
<?php
		$i = 1;
		...
		<form method="post" action="">
			<table border="0" cellspacing="0" cellpadding="0" width="97%" class="table1">
				...
				<tr>
					...
					<td align="left"><select width="80%" size="1" name="admin"><option value="0">DJ</option><option value="1">Administrator</option></select></td>
				...
				<tr>
					...
					<td colspan="5"><div class="podpis"><?=$dj->getError() ? "<font color='red'>".$dj->getError()."</font>&nbsp;&nbsp;&nbsp;&nbsp;" : ''?>DJ have an access to the "Stats" module and partially to "Your DJs" (only read the list DJ) and "Status" (to switch radioshow and autodj without turn off), Administrator - access to all modules.</div></td>
				</tr>
			</table>
		</form>
	</div>
